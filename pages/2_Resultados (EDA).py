...
with st.container():
    ...
    contexto = st.text_area(
        ...
        value="""Contiene información prevalente de los presuntos suicidios ocurridos en el territorio nacional Colombiano en el periodo de tiempo comprendido entre los años 2015 a 2024, de los cuales tiene conocimiento y son registrados por el Instituto Nacional de Medicina Legal y Ciencias Forenses.""",
        height=150
    )
...
""",
    ...
    estadisticas = st.text_area(
        ...
        value="""- El perfil típico de una víctima de suicidio en Colombia durante el período 2015-2024 es: hombre, adulto (29-59 años), soltero, con bajo nivel educativo, que utiliza ahorcamiento y lo hace en su vivienda, generalmente por conflictos de pareja o enfermedades.
- Proyectil de arma de fuego: es un método con una presencia constante, lo que puede estar relacionado con contextos de conflicto, pertenencia a fuerzas armadas o acceso a armas en zonas rurales.
...
""",
    ...
    conclusion = st.text_area(
        ...
        value="""El mensaje principal que nos dan estos datos es la importancia y la relevancia del suicidio en Colombia. Esto permite sacar conclusiones sobre la salud mental de los colombianos y la necesidad de fortalecer las estrategias de prevención, atención psicológica y apoyo social.""",
        height=120
    )
